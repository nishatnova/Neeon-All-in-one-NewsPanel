...
<head>
    ...
    <!-- TITLE -->
    <title>Neeon Admin | login</title>

    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}admin/{{asset('/')}}admin/assets/images/brand/favicon.ico" />
    ...
    <div>
        ...
        <div class="col col-login mx-auto text-center">
            <a href="index.html" class="text-center">
                <img src="{{asset('/')}}website/media/logo/logo-dark.svg" class="header-brand-img" alt="">
            </a>
        </div>
