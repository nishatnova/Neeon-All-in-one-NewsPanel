                        ...
                        <nav class="main-menu__nav">
                            <ul>
                                ...
                                <li class="main-menu__nav_sub list">
                                    ...
                                    <ul class="main-menu__dropdown">
                                        <li class="main-menu__nav_sub">
                                            ...
                                            <ul>
                                                <li><a href="{{route('news-detail')}}">Post 01</a></li>
                                ...
                                <li class="main-menu__nav_sub list">
                                    ...
                                    <ul class="main-menu__dropdown">
                                        <li><a href="{{route('news-category')}}">Life Style</a></li>
                                        <li><a href="{{route('news-category')}}">Technology</a></li>
                                ...
                                @foreach($headCategories as $headCategory)
                                    <li class="list"><a href="{{route('news-category')}}" class="animation">{{$headCategory->name}}</a></li>
                                @endforeach
