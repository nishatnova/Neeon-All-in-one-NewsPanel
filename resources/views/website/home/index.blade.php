            ...
            <div class="row gutter-24">
                ...
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                    <div class="rt-post post-sm style-1">
                        <div class="post-img">
                            <a href="{{route('news-category', ['id' => $latestCategory->id])}}">
                                <img src="{{asset($latestCategory->image)}}" alt="post" width="100" height="100">
                            </a>
                        </div>
                        <div class="ms-4 post-content">
                            <a href="{{route('news-category', ['id' => $latestCategory->id])}}" class="rt-post-cat-normal">{{$latestCategory->name}}</a>
                            <h3 class="post-title">
                                <a href="{{route('news-category', ['id' => $latestCategory->id])}}">
                            ...
                            <span class="rt-meta">
                                 ...
                                 {{$latestCategory->updated_at->format('M d,Y')}}
                              </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gutter-24">
                ...
                <div class="col-xl-7 col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                    <div class="rt-post-overlay rt-post-overlay-xl layout-1">
                        <div class="post-img">
                            <a href="{{route('news-detail', ['id'=> $last_post->id])}}" class="img-link">
                                <img src="{{asset($last_post->image)}}" alt="post-xl_1" width="900" height="600">
                            </a>
                        </div>
                        <div class="post-content">
                            <a href="life-style.html" class="fashion">{{$last_post->category->name}}</a>
                            <h3 class="post-title bold-underline">
                                <a href="{{route('news-detail', ['id'=> $last_post->id])}}">
                                    {{$last_post->title}}
                                </a>
                            </h3>
                            <div class="post-meta">
                                <ul>
                                    <li>
                                       <span class="rt-meta">
                                          by <a href="author.html" class="name">{{$last_post->reporter->name}}</a>
                                       </span>
                                    </li>
                                    <li>
                                       <span class="rt-meta">
                                          <i class="far fa-calendar-alt icon"></i>
                                          {{$last_post->created_at->format('M d,Y')}}
                                       </span>
                                    </li>
                                    <li>
                                       <span class="rt-meta">
                    ...
                    <div class="row gutter-24">
                        ...
                        <div class="col-12 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="800ms">
                            <div class="rt-post post-md style-10">
                                <div class="post-img">
                                    <a href="{{route('news-detail', ['id'=> $latestPost->id])}}">
                                        <img src="{{asset($latestPost->image)}}" alt="post" width="696" height="491">
                                    </a>
                                </div>
                                <div class="post-content">
                                    <a href="life-style.html" class="food">{{$latestPost->category->name}}</a>
                                    <h3 class="post-title">
                                        <a href="{{route('news-detail', ['id'=> $latestPost->id])}}">
                                            {{$latestPost->title}}
                                        </a>
            ...
            <div class="row gutter-24">
                    ...
                    <div class="rt-post-grid grid-meta">
                        <div class="post-img">
                            <a href="single-post1.html">
                                <img src="{{asset('/')}}website/media/gallery/post-md_1.jpg" alt="post" width="551" height="431">
                            </a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="800ms">
                    <div class="rt-post-grid grid-meta">
                        <div class="post-img">
                            <a href="single-post1.html">
                                <img src="{{asset('/')}}website/media/gallery/post-md_2.jpg" alt="post" width="551" height="431">
                            </a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="800ms">
                    <div class="rt-post-grid grid-meta">
                        <div class="post-img">
                            <a href="single-post1.html">
                                <img src="{{asset('/')}}website/media/gallery/post-md_3.jpg" alt="post" width="551" height="431">
                            </a>
                        </div>
                        <div class="post-content">
                ...
                <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="800ms" data-wow-duration="800ms">
                    <div class="rt-post-grid grid-meta">
                        <div class="post-img">
                            <a href="single-post1.html">
                                <img src="{{asset('/')}}website/media/gallery/post-md_4.jpg" alt="post" width="551" height="431">
                            </a>
                        </div>
                        <div class="post-content">
                            ...
                            <div class="featured-tab-title">
                                ...
                                <ul class="nav rt-tab-menu" id="myTab" role="tablist">
                                    ...
                                    <li class="menu-item" role="presentation">
                                        <a class="menu-link" id="menu-1-tab" data-bs-toggle="tab" href="{{route('news-category', ['id' => $latestCategory->id])}}"
                                           role="tab" aria-controls="menu-1" aria-selected="true"> {{$latestCategory->name}} </a>
                                    </li>
                                    @endforeach
                                            ...
                                            <div class="rt-post-overlay rt-post-overlay-lg">
                                                <div class="post-img">
                                                    <a href="single-post1.html" class="img-link">
                                                        <img src="{{asset('/')}}website/media/gallery/post-xl_2.jpg" alt="post-xl-2" width="900"
                                                             height="600">
                                                    </a>
                                                </div>
                                                <div class="post-content">
                                            ...
                                            <div class="row gutter-24">
                                                <div class="col-12">
                                                    <div class="rt-post post-sm style-2">
                                                        ...
                                                        <div class="post-img">
                                                            <a href="single-post1.html">
                                                                <img src="{{asset('/')}}website/media/gallery/post-sm_5.jpg" alt="post" width="143"
                                                                     height="110">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="rt-post post-sm style-2">
                                                        ...
                                                        <div class="post-img">
                                                            <a href="single-post1.html">
                                                                <img src="{{asset('/')}}website/media/gallery/post-sm_6.jpg" alt="post" width="143"
                                                                     height="110">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="rt-post post-sm style-2">
                                                        ...
                                                        <div class="post-img">
                                                            <a href="single-post1.html">
                                                                <img src="{{asset('/')}}website/media/gallery/post-sm_7.jpg" alt="post" width="143"
                                                                     height="110">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="rt-post post-sm style-2">
                                                        ...
                                                        <div class="post-img">
                                                            <a href="single-post1.html">
                                                                <img src="{{asset('/')}}website/media/gallery/post-sm_8.jpg" alt="post" width="143"
                                                                     height="110">
                                                            </a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row gutter-24">
                                        <div class="col-lg-7">
                                            <div class="rt-post-overlay rt-post-overlay-lg">
                                                <div class="post-img">
                                                    <a href="single-post1.html" class="img-link">
                                                        <img src="{{asset('/')}}website/media/gallery/post-xl_2.jpg" alt="post-xl_2" width="900"
                                                             height="600">
                                                    </a>
                                                </div>
                                                <div class="post-content">
                            ...
                            <div class="row gutter-10">
                                ...
                                <div class="col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                                    <div class="rt-post-overlay rt-post-overlay-md">
                                        <div class="post-img">
                                            <a href="{{route('news-detail', ['id'=> $lifestylePost->id])}}" class="img-link">
                                                <img src="{{asset($lifestylePost->image)}}" alt="post-xl_4" width="900"
                                                     height="600">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                            <h3 class="post-title bold-underline">
                                                <a href="{{route('news-detail', ['id'=> $lifestylePost->id])}}">
                                                    {{$lifestylePost->title}}
                                                </a>
                                            </h3>
                                            ...
                                            <div class="post-meta">
                                                <ul>
                                                    <li>
                                                   <span class="rt-meta">
                                                      by <a href="author.html" class="name">{{$lifestylePost->reporter->name}}</a>
                                                   </span>
                                                    </li>
                                                    <li>
                                                   <span class="rt-meta">
                                                      <i class="far fa-calendar-alt icon"></i>
                                                      {{$lifestylePost->created_at->format('M d, Y')}}
                                                   </span>
                                                    </li>
                                                </ul>
                                            </div>
        ...
        <div class="swiper-container video-slider-style-1">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="item  video-slide" data-bg-image="{{asset('/')}}website/media/gallery/video-gallery-bg_1.jpg">
                        <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="item  video-slide" data-bg-image="{{asset('/')}}website/media/gallery/video-gallery-bg_2.jpg">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="post-content text-center">
                ...
                <div class="swiper-slide">
                    <div class="item  video-slide" data-bg-image="{{asset('/')}}website/media/gallery/video-gallery-bg_3.jpg">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="post-content text-center">
                ...
                <div class="swiper-slide">
                    <div class="item  video-slide" data-bg-image="{{asset('/')}}website/media/gallery/video-gallery-bg_4.jpg">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="post-content text-center">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="item video-slide-thumb">
                                <div class="rt-post post-sm post-thumb">
                                    <div class="post-img">
                                        <img src="{{asset('/')}}website/media/gallery/video-thumb_1.jpg" alt="post" width="130" height="100">
                                    </div>
                        ...
                        <div class="swiper-slide ">
                            <div class="item video-slide-thumb">
                                <div class="rt-post post-sm post-thumb">
                                    <div class="post-img">
                                        <img src="{{asset('/')}}website/media/gallery/video-thumb_2.jpg" alt="post" width="130" height="100">
                                    </div>
                                    <div class="ms-3 post-content">
                        ...
                        <div class="swiper-slide">
                            <div class="item video-slide-thumb">
                                <div class="rt-post post-sm post-thumb">
                                    <div class="post-img">
                                        <img src="{{asset('/')}}website/media/gallery/video-thumb_3.jpg" alt="post" width="130" height="100">
                                    </div>
                                    <div class="ms-3 post-content">
                        ...
                        <div class="swiper-slide">
                            <div class="item video-slide-thumb">
                                <div class="rt-post post-sm post-thumb">
                                    <div class="post-img">
                                        <img src="{{asset('/')}}website/media/gallery/video-thumb_4.jpg" alt="post" width="130" height="100">
                                    </div>
                                    <div class="ms-3 post-content">
                        ...
                        <div class="wrap post-wrap mb--60">
                            ...
                            <div class="post-item wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                                <div class="rt-post post-md style-2 grid-meta">
                                    <div class="post-img">
                                        <a href="single-post1.html">
                                            <img src="{{asset('/')}}website/media/gallery/post-lg_4.jpg" alt="post" width="696" height="491">
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="post-item wow fadeInUp" data-wow-delay="400ms" data-wow-duration="800ms">
                                <div class="rt-post post-md style-2 grid-meta">
                                    <div class="post-img">
                                        <a href="single-post1.html">
                                            <img src="{{asset('/')}}website/media/gallery/post-lg_5.jpg" alt="post" width="696" height="491">
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="post-item wow fadeInUp" data-wow-delay="600ms" data-wow-duration="800ms">
                                <div class="rt-post post-md style-2 grid-meta">
                                    <div class="post-img">
                                        <a href="single-post1.html">
                                            <img src="{{asset('/')}}website/media/gallery/post-lg_6.jpg" alt="post" width="696" height="491">
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="post-item wow fadeInUp" data-wow-delay="800ms" data-wow-duration="800ms">
                                <div class="rt-post post-md style-2 grid-meta">
                                    <div class="post-img">
                                        <a href="single-post1.html">
                                            <img src="{{asset('/')}}website/media/gallery/post-lg_7.jpg" alt="post" width="696" height="491">
                                        </a>
                                    </div>
                                    <div class="post-content">
                            ...
                            <div class="row rt-gutter-10">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_1.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_2.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_3.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_4.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_5.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                ...
                                <div class="col-6">
                                    <div class="rt-post-grid post-grid-md grid-meta">
                                        <div class="post-img">
                                            <a href="single-post1.html">
                                                <img src="{{asset('/')}}website/media/gallery/post-grid-md_6.jpg" alt="post" width="343"
                                                     height="250">
                                            </a>
                                        </div>
                                        <div class="post-content">
