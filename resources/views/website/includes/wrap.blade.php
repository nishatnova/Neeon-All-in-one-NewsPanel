        ...
        <div class="offcanvas-header">
            <div class="offcanvas-logo">
                <div class="site-branding">
                    <a class="dark-logo" href="index.html"><img width="162" height="52" src="{{asset('/')}}website/media/logo/logo-dark.svg"
                                                                alt="neeon"></a>
                    <a class="light-logo" href="index.html"><img width="162" height="52"
                                                                 src="{{asset('/')}}website/media/logo/logo-light.svg" alt="neeon"></a>
                </div>
            </div>
            ...
            <div class="insta-gallery">
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_1.jpg" width="100" height="90" alt="gallery1">
                    </a>
                </div>
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_2.jpg" width="100" height="90" alt="gallery2">
                    </a>
                </div>
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_3.jpg" width="100" height="90" alt="gallery3">
                    </a>
                </div>
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_4.jpg" width="100" height="90" alt="gallery4">
                    </a>
                </div>
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_5.jpg" width="100" height="90" alt="gallery5">
                    </a>
                </div>
                <div class="galleryitem">
                    <a href="https://www.instagram.com/">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_6.jpg" width="100" height="90" alt="gallery6">
                    </a>
                </div>
            </div>
        </div>
        ...
        <ul class="cart-items ">
            <li class="d-flex ">
                <div class="item-figure">
                    <a href="#">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_1.jpg" alt="Cart" width="100" height="90">
                    </a>
            ...
            <li class="d-flex">
                <div class="item-figure">
                    <a href="#">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_2.jpg" alt="Cart" width="100" height="90">
                    </a>
                    <div class="item-dismiss">
                        <a href="#"><i class="fas fa-times"></i></a>
                    </div>
            ...
            <li class="d-flex">
                <div class="item-figure">
                    <a href="#">
                        <img src="{{asset('/')}}website/media/gallery/ins-gallery_3.jpg" alt="Cart" width="100" height="90">
                    </a>
                    <div class="item-dismiss">
                        <a href="#"><i class="fas fa-times"></i></a>
                    </div>
